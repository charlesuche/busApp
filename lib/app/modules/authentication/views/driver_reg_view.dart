...
class DriverRegView extends GetView {
  TextEditingController full_nameCont = TextEditingController();
  TextEditingController driverIdCont = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        children: [
            Text('Driver\'s Reg', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Colors.white),),
               SizedBox(height: 15,),
                        ...
                        child: Column(
                          children: [
                            ...
                            TextFormField(
                              ...
                              controller: driverIdCont,
                              onChanged: (val) {
                            val= driverIdCont.text;
                              },
                            ),
                            TextFormField(
                              obscureText: true,
...
Widget loginForm(
    height, width, namecont, driverIdCont, passwordcont, Widget page) {
  return ClipRRect(
    borderRadius: BorderRadius.only(
      topLeft: Radius.circular(50),
      bottomRight: Radius.circular(50),
